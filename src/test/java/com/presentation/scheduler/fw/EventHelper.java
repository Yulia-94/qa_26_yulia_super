...
public class EventHelper extends HelperBase{
    ...
    public void initCreationNew() {
       click(By.xpath("//*[@resource-id='com.example.svetlana.scheduler:id/fab_main']"));
       click(By.xpath("//*[@resource-id='com.example.svetlana.scheduler:id/fab_add_event']"));
    }
    ...
    public void fillCreationForm(Event event) {
        ...
        type(By.xpath("//*[@resource-id='com.example.svetlana.scheduler:id/info_wage_input']"),String.valueOf(event.getAmmout()));
        click(By.xpath("//*[@resource-id='com.example.svetlana.scheduler:id/info_wage_save']"));
    }
    public void confirmCreation() {
        click(By.xpath("//*[@resource-id='com.example.svetlana.scheduler:id/info_save_btn']"));
    }

    public void getSelectNextDay() {
